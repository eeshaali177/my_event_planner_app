class CommentsController < ApplicationController
  ...
  # POST /comments or /comments.json
def create
  # Create a new comment object with permitted parameters
  @comment = Comment.new(comment_params)

  # Set the event ID based on the parameter passed in the request
  @comment.event_id = params[:event_id]

  # Set the user ID based on the currently logged-in user

...
class InvitationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invitation" do
    assert_difference("Invitation.count") do
      post invitations_url, params: { invitation: { event_id: @invitation.event_id, recipient_email: @invitation.recipient_email, sender_id: @invitation.sender_id } }
    end
  ...
  test "should update invitation" do
    patch invitation_url(@invitation), params: { invitation: { event_id: @invitation.event_id, recipient_email: @invitation.recipient_email, sender_id: @invitation.sender_id } }
